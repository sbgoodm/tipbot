...
describe('When talking to TIPBot', function() {
    ...
    // Mocked OTX responses. I would prefer to house this content in formatted external JSON files, but not critical given small number of tests, and it's really, really late at the moment :-).
